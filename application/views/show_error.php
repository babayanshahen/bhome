...
<head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="animte.css"> -->
</head>
<style>
...
.header{
	font-family: monospace;
  	font-size: 62px;
  	margin-bottom: 1px;
  	background: linear-gradient(-45deg, #8D9AFF, #424f95, #8D9AFF, #424f95 );
...
.clock .middle {
  ...
  z-index: 9;
  background: -webkit-linear-gradient(left, #8D9AFF 30%, #424f95 100%);
...
<p class="header">Page Not Found</p>
<h2>The page you are looking for does not exist or has changed</h2>



	<div class="clock">
		<p class="number-1">4</p>
		<a href="<?php echo base_url() ?> "><div class="middle"> <i class="fa fa-home fa-2x home"></i> </div></a>
